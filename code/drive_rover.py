...
sio = socketio.Server(async_mode='eventlet', always_connect=False, async_handlers=True, cors_allowed_origins="*")
# app = Flask(__name__)
...
def telemetry(sid, data):
	if data:
		...
		print('speed=', Rover.vel, 'position', Rover.pos, 'throttle', Rover.throttle, 'steer_angle', Rover.steer)
